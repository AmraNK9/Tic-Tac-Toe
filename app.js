...
const checkWinner = () => {
  for (let i = 0; i < winCondition.length; i++) {
    if (
      spaces[winCondition[i][0]].innerHTML == "X" &&
      spaces[winCondition[i][1]].innerHTML == "X" &&
      spaces[winCondition[i][2]].innerHTML == "X"
    ) {
      ...
      spaces[winCondition[i][0]].innerHTML == "O" &&
      spaces[winCondition[i][1]].innerHTML == "O" &&
      spaces[winCondition[i][2]].innerHTML == "O"
    ) {
...
let xTurn = true;
let player2 = localStorage.getItem("player1") || "X";
let player1 = localStorage.getItem("player2") || "O";
